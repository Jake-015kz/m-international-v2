...
## Tailwind CSS 4 + shadcn/ui — Совместимость

> **Важно:** Tailwind CSS 4 использует CSS-first конфигурацию.
> НЕ используйте `tailwind.config.js`. Всё через `@theme` в CSS.

### postcss.config.js для Tailwind 4
...
### globals.css для Tailwind 4 + shadcn
