...
export default function Footer() {
  return (
    <footer id="contacts" className="relative bg-[#0d1f0d] text-white overflow-hidden">
      {/* Top accent line */}
      ...
      <Container className="relative z-10 py-10 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="md:col-span-1">
            <h3 className="font-unbounded font-bold text-lg md:text-xl text-white mb-2">
              M-International
            </h3>
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center transition-colors duration-300"
                aria-label="Instagram"
              >
                <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-white/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a
                ...
                aria-label="Telegram"
              >
                <Send className="w-3.5 h-3.5 md:w-4 md:h-4 text-white/60" />
              </a>
            </div>
          </div>
          ...
          {/* Company links */}
          <div>
            <h4 className="font-unbounded font-bold text-xs uppercase tracking-wider text-white/60 mb-3 md:mb-4">
              Компания
            </h4>
            <ul className="space-y-2">
              {footerLinks.company.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-xs md:text-sm text-white/40 hover:text-white/70 font-onest font-light transition-colors duration-200"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <p className="text-xs text-white/40 font-onest font-light mb-3">
          ...
          <div className="flex items-center gap-4">
            {footerLinks.legal.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="text-[10px] md:text-xs text-white/30 hover:text-white/50 font-onest transition-colors duration-200"
              >
                {link.label}
              </a>
            ))}
