  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        <div className="w-16 h-16 rounded-full bg-accent-50 border border-accent-100 flex items-center justify-center mx-auto mb-4">
  ...
  return (
    <section id="about" className="relative py-12 md:py-24 overflow-hidden bg-bg-alt" style={{ contentVisibility: "auto", containIntrinsicSize: "0 800px" }}>
      ...
      <Container className="relative z-10">
        ...
        {/* Timeline — now animated with GSAP */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 max-w-4xl mx-auto">
            {steps.map((s, i) => (
              <ScrollReveal key={s.title} delay={i * 0.12}>
                <div className="group relative p-5 md:p-8 rounded-2xl bg-bg-elevated border border-border-subtle hover:border-border-default transition-all duration-500 hover:shadow-float hover:-translate-y-2 text-center overflow-hidden">
                  ...
                  <h4 className="font-unbounded font-bold text-sm md:text-lg text-fg-primary mb-1.5 md:mb-2">{s.title}</h4>
                  <p className="text-[11px] md:text-sm text-fg-secondary font-onest font-light leading-relaxed">{s.desc}</p>
                  {i < steps.length - 1 && (
        ...
        <div className="mt-10 md:mt-20">
          <ScrollReveal>
            <div className="max-w-lg mx-auto">
              ...
              <div className="p-5 md:p-8 rounded-2xl bg-bg-elevated border border-border-subtle shadow-sm">
                <RegistrationForm />
              </div>
            </div>
          </ScrollReveal>
